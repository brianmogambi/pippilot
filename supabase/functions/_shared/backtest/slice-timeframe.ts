// Phase 10: Lookahead-safe candle slicing. Deno mirror — keep in sync
// with src/lib/backtest/slice-timeframe.ts (only difference: .ts import).
...
import type { BacktestCandle, PairCandleSet } from "./types.ts";
